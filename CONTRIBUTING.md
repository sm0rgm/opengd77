...
2. Skapa ett [issue](https://github.com/sm0rgm/opengd77/issues) (lätt för dig och smidigt för mig, men du måste ha ett konto på GitHub - var så tydlig som möjligt med vad som är fel i kodpluggen)
